 ...
 * 
 */
package com.gk.htc.ahp.brand.jsmpp;
...
public interface SMPPConstant {
     ...
     */
    public static final int STAT_ESME_ROK = 0x00000000;                     // No Error
    public static final int STAT_ESME_RINVMSGLEN = 0x00000001;              // Message Length is invalid
    public static final int STAT_ESME_RINVCMDLEN = 0x00000002;              // Command Length is invalid
    public static final int STAT_ESME_RINVCMDID = 0x00000003;               // Invalid Command ID
