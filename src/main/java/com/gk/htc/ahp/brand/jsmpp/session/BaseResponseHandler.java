...
public interface BaseResponseHandler {
     ...
     * sequenceNumber. Return <tt>null</tt> if the the mapped sequenceNumber not
     * found
     */
     ...
     * @param sequenceNumber is the sequence number original PDU if can be
     * decoded.
     ...
     *
     * @param sequenceNumber is the sequence number of original
     * <b>ENQUIRE_LINK</b>
     * request.
     * @throws IOException if an IO error occur.
     */
     ...
     *
     * @param sequenceNumber is the sequence number of original <b>UNBIND</b>
     * request.
     * @throws IOException if an IO error occur.
     */
