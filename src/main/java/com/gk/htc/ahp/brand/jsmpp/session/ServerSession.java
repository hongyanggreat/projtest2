...
public interface ServerSession {
    ...
    /**
     * Submit a short message to specified destination address (ESME). This
     * method will blocks until response received or timeout reached. This
     * method simplify operations of sending DELIVER_SM command and receiving
     * the DELIVER_SM_RESP.
     *
