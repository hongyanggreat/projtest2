...
import com.gk.htc.ahp.brand.jsmpp.util.StringParameter;
import com.gk.htc.ahp.brand.jsmpp.util.StringValidator;
...
public class BindRequest {
     ...
     * @throws IllegalStateException if the acceptance or rejection has been
     * made.
