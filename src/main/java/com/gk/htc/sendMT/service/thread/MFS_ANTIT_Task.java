 ...
 * @author TUANPLA
 */
public class MFS_ANTIT_Task extends _AbstractThreadSend2Provider {

    private static final Logger logger = Logger.getLogger(MFS_ANTIT_Task.class);
    private static final String USER = "mfs";
    private static final String PASS = "mfs@123";

    private static final WorkQueue WORKQUEUE_MFS_ANTIT = new WorkQueue("WORKQUEUE_MFS_ANTIT", 10);
    private static final String QUEUE_NAME = "Q-->SEND_TO_MFS_ANTIT_QUEUE";

    /**
     *
     */
    public MFS_ANTIT_Task() {
        super(QUEUE_NAME);
        TPS = WORKQUEUE_MFS_ANTIT.getMaxPoolSize();
        this.setName("MFS_ANTIT_Task [" + DateProc.createTimestamp() + "]");
        MonitorWorker.addDemonName(this.getName());
        MonitorWorker.addWorkQueue(WORKQUEUE_MFS_ANTIT);
    }
        ...
        try {
            ...
            while (AppStart.isRuning & !stop) {
                ...
                if (!oneQueueBr.isShutDown()) {
                    WORKQUEUE_MFS_ANTIT.execute(doSendBrand_runnable(oneQueueBr));
                }
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    oneQueue.setCacheFrom("Send2ANTITviaMFS:" + e.getMessage());
    ...
    public static enum STATUS {
        ...
        SUCCESS(200, "OK"), // Thuc chat la VMG
    ...
    private static String sendMT(String msisdn, String brandname, String msgbody, String user, String pass) {
        com.gk.htc.sendMT.MFS.ANTIT.AntitApi_Service service = new com.gk.htc.sendMT.MFS.ANTIT.AntitApi_Service();
        com.gk.htc.sendMT.MFS.ANTIT.AntitApi port = service.getAntitApiPort();
