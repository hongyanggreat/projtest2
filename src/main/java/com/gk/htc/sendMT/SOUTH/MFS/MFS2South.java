 ...
 */
package com.gk.htc.sendMT.SOUTH.MFS;

import com.gk.htc.ahp.brand.common.Tool;
import com.gk.htc.ahp.brand.entity.SmsBrandQueue;
import com.gk.htc.sendMT.SOUTH.SouthRequest;
 ...
 * @author TUANPLA
 */
public class MFS2South {

    static final Logger logger = Logger.getLogger(MFS2South.class);
    private static final String authKey = "YWR0OllCdjNjcHRqczZ2ZXp4S24=";
