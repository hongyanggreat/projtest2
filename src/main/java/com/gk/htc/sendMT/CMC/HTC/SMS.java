 ...
 * 
 */
@WebServiceClient(name = "SMS", targetNamespace = "http://w2m.bluezone.vn/", wsdlLocation = "http://124.158.6.45/HTC/Service.asmx?WSDL")
public class SMS
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://124.158.6.45/HTC/Service.asmx?WSDL");
