...
public interface BrandNameWS {
    ...
    @RequestWrapper(localName = "uploadSMS", targetNamespace = "http://sms.mc.vasc.com/", className = "com.gk.htc.sendMT.VNPTMediaUnicode.UploadSMS")
    @ResponseWrapper(localName = "uploadSMSResponse", targetNamespace = "http://sms.mc.vasc.com/", className = "com.gk.htc.sendMT.VNPTMediaUnicode.UploadSMSResponse")
    ...
    public int uploadSMS(
        ...
        String infor,
        @WebParam(name = "dataCoding", targetNamespace = "")
        int dataCoding
    );
